                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                            <tr>
                                <td valign="top" class="bodyContent">
                                    <h1 style="color:#0ec9dc!important;margin-bottom:30px;text-align:center;">Leave Request from {{ auth('employee')->user()->name }}</h1>
                                    <p>Date: {{ date('d M Y', strtotime($leaveDetails->date_from)) .' to '. date('d M Y', strtotime($leaveDetails->date_to)) }} ({{ $days }} days)</p>
                                    <br>
                                    <p>Details: {{ $leaveDetails->details }}</p>
