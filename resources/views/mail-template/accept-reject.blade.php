...
<head>
    ...
    <style type="text/css">
        ...
        body, #bodyTable, #bodyCell{height:100% !important; margin:0; padding:0; width:100% !important;font-family: 'Raleway', sans-serif, SolaimanLipi ,SolaimanLipiNormal;}
        ...
        #templateHeader{
            ...
            {{--@editable--}} border-bottom:1px solid #eee;
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                            <tr>
                                <td valign="top" class="bodyContent">
                                    <h1 style="color:#0ec9dc!important;margin-bottom:30px;text-align:center;">Leave Request {{ $status }}</h1>

                                    <p>Your leave request has been {{ strtolower($status) }}.</p><br>
                                    <p>Date: {{ date('d M Y', strtotime($leaveDetails->date_from)) .' to '. date('d M Y', strtotime($leaveDetails->date_to)) }} ({{ $leaveDetails->total_days }} days)</p>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                            <tr>
                                <td valign="top" class="footerContent">
                                    © {{ date('Y') }} Leave Management. All rights reserved.
                                </td>
                            </tr>
                        </table>
                    </td>
